...
---
# 🔸pull
Here's a short but informative study note on `git pull` for Obsidian:

---

### Git Pull Command - Quick Reference
...
This concise note will help you quickly recall how `git pull` works while using Obsidian!
